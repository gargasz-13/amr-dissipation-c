...
void amr_dissipation(int num_containers, struct box boxes[], double results[], double difference, double temp_dsv[], float epsilon, float affect_rate) {
...
int main(int argc, char *argv[]) {
    ...
    {
        amr_dissipation(num_containers, boxes, results, difference, temp_dsv, epsilon, affect_rate);
    }
